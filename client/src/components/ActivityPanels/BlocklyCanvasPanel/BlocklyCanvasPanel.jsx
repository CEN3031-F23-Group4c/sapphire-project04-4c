...
const BlocklyCanvasPanel = ({ activity, isSandbox, setActivity, isGradeActivity }) => {
  ...
  switch (userRole) {
    ...
    case 'Mentor':
      ...
      isSandbox={isSandbox}
      isMentorActivity={!activity.selectedToolbox && !isSandbox && !isGradeActivity}
      isGradeActivity={!isSandbox && isGradeActivity}
      />;
    case 'ContentCreator':
      return (
