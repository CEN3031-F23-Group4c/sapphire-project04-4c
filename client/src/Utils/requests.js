...
export const updateGradeActivityTemplate = async (id, workspace) =>
  makeRequest({
    method: PUT,
    path: `${server}/activities/grade_template/${id}`,
    data: {
      grade_template: workspace,
    },
    auth: true,
    error: 'Failed to update the grade template for the activity',
  });
